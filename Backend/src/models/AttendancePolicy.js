...
const attendancePolicySchema = new mongoose.Schema(
  {
    ...
    // Phase 31.13 — reminder configuration only. All types are OFF by
    // default; HR opts in per type. Minutes are bounded integers.
    notifications: {
      shiftStart: {
        enabled: { type: Boolean, default: false },
        minutesBefore: { type: Number, default: 30, min: 0, max: 180 },
      },
      missingClockIn: {
        enabled: { type: Boolean, default: false },
        minutesAfter: { type: Number, default: 30, min: 0, max: 720 },
      },
      missingClockOut: {
        enabled: { type: Boolean, default: false },
        minutesAfter: { type: Number, default: 30, min: 0, max: 720 },
      ...
      incompleteBreak: {
        enabled: { type: Boolean, default: false },
        minutesAfter: { type: Number, default: 45, min: 15, max: 720 },
      },
    },
