// ─────────────────────────────────────────────────────────────
// Phase 29.7 — Payroll review scope middleware (§3 / §24)
//
// Reuses the 29.1 payroll scope: a manager reviews their own
// team, COMPANY scope reviews everyone. `null` means "whole
// company" downstream, which is exactly what the service
// understands.
//
...
export const payrollReviewScope = async (req, res, next) => {
  try {
...
export const assertEmployeeInReviewScope = (req, res, next) => {
...
export default payrollReviewScope;
