...
export const DEFAULT_PERMISSIONS = [
  ...
  ...actions("REQUISITION", ["READ", "UPDATE"], "SELF"),

  ...actions("OFFER", ["READ", "CREATE", "UPDATE", "DELETE", "APPROVE"]),

  ...actions("ONBOARDING", ["READ", "UPDATE", "MANAGE"]),

  ...actions("ATS", ["READ", "MANAGE"]),
