...
export const attendancePolicyDraftValidator = [
  ...
  body('overtime.normalDayBenefit').optional().isIn(['OVERTIME', 'NONE']),
  body('overtime.weeklyOffBenefit').optional().isIn(['NONE', 'OVERTIME', 'COMP_OFF']),
  body('overtime.holidayBenefit').optional().isIn(['NONE', 'OVERTIME', 'COMP_OFF']),
  body('overtime.compOffMinutesPerDay').optional().isInt({ min: 1, max: 1440 }),
