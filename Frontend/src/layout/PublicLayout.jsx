    ...
    <div className="flex min-h-screen flex-col bg-crewly-bg text-crewly-text">
      ...
      <div className="relative z-40 flex items-center justify-center gap-2 bg-gradient-to-r from-crewly-green to-emerald-600 px-4 py-2 text-center text-xs font-semibold text-white sm:gap-3 sm:px-6 sm:text-[13px]">
        ...
        <span className="truncate">
          AI-powered Recruitment + Geofenced Attendance now live — trusted by 10,000+ teams
        </span>
        <Link
          to="/register"
          className="hidden shrink-0 items-center gap-1 rounded-full bg-white px-3 py-1 text-xs font-bold text-crewly-green transition hover:bg-white/90 sm:inline-flex"
        >
      ...
      <header
        className={`sticky top-0 z-30 border-b backdrop-blur-xl transition ${
          scrolled
            ? 'border-crewly-border bg-crewly-bg/80 shadow-sm'
            : 'border-transparent bg-crewly-bg/60'
        }`}
      >
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 py-3.5 sm:px-6 lg:px-8">
          {/* Logo */}
          <Link to="/" className="flex shrink-0 items-center gap-2.5">
            <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-crewly-green font-black text-crewly-bg sm:h-9 sm:w-9">
              C
            </div>
          ...
          <nav className="hidden items-center gap-1 lg:flex">
            {NAV_LINKS.map((l) => (
              <a
                ...
                className="rounded-full px-3.5 py-2 text-sm font-medium text-crewly-dim transition hover:bg-crewly-card hover:text-crewly-text"
              >
                {l.label}
              </a>
            ))}
          ...
          <div className="hidden items-center gap-2 lg:flex">
            <Link
              to="/login"
              className="rounded-full px-4 py-2 text-sm font-semibold text-crewly-text transition hover:bg-crewly-card"
            >
              Sign in
            </Link>
            <Link
              to="/register"
              className="inline-flex items-center gap-1.5 rounded-full bg-crewly-green px-5 py-2.5 text-sm font-bold text-crewly-bg shadow-lg shadow-crewly-green/20 transition hover:bg-[#35a344] hover:shadow-xl active:scale-[0.98]"
            >
          ...
          <div className="flex items-center gap-2 lg:hidden">
            <Link
              to="/register"
              className="inline-flex items-center gap-1 rounded-full bg-crewly-green px-4 py-2 text-xs font-bold text-crewly-bg"
            >
              Try free
            </Link>
            <button
              ...
              className="inline-flex h-9 w-9 items-center justify-center rounded-xl border border-crewly-border bg-crewly-card text-crewly-text transition hover:border-crewly-green/30"
            ...
            <nav className="flex flex-col gap-1">
              {NAV_LINKS.map((l) => (
                <a
                  ...
                  href={l.href}
                  onClick={(e) => handleNavClick(e, l.href)}
                  className="rounded-xl px-3 py-3 text-sm font-medium text-crewly-dim hover:bg-crewly-bg hover:text-crewly-text"
                >
                  {l.label}
                </a>
              ))}
      ...
      {/* Footer - SaaS grade */}
      <footer className="border-t border-crewly-border bg-[#0a0e13] text-crewly-dim">
        <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 sm:py-12 lg:px-8">
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-5">
            {/* Brand */}
            <div className="sm:col-span-2 lg:col-span-2">
              <Link to="/" className="flex items-center gap-2">
                <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-crewly-green font-black text-crewly-bg">
                  C
                </div>
              ...
              <p className="mt-3 max-w-sm text-sm leading-relaxed">
                The modern, multi-tenant HRMS for ambitious teams. Attendance, Payroll, Recruitment,
                Performance & more — in one beautifully fast workspace.
              </p>
