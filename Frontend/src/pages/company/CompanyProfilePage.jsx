...
import { Building2, Check, Copy, ExternalLink, FileText, Globe2, ImagePlus, Trash2, Eye, Loader2 } from 'lucide-react';
...
const CompanyProfilePage = () => {
  ...
  return (
    <div className="p-6 space-y-6">
      <div>
        <h1 className="flex items-center gap-2 text-xl font-bold"><Building2 className="h-5 w-5 text-crewly-green" />Company Profile</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="card p-5 space-y-3">
          <h2 className="flex items-center gap-1.5 text-sm font-semibold"><FileText className="h-4 w-4" />Payslip header preview</h2>
